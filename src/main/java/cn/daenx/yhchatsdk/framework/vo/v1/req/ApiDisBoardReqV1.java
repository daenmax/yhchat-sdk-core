...
public class ApiDisBoardReqV1 {
     ...
     * @return
     */
    public ApiDisBoardReqV1 Text(String recvType, String recvId, String content) {
        this.recvId = recvId;
     ...
     * @return
     */
    public ApiDisBoardReqV1 Markdown(String recvType, String recvId, String content) {
        this.recvId = recvId;
        this.recvType = recvType;
     ...
     * @return
     */
    public ApiDisBoardReqV1 Html(String recvType, String recvId, String content) {
        this.recvId = recvId;
        this.recvType = recvType;
